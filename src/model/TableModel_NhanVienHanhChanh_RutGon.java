...
public class TableModel_NhanVienHanhChanh_RutGon extends AbstractTableModel{
	...
	private static final int soDienThoai = 3;
	private static final int chucVu = 4;
	private static final int luongCoBan = 5;
	private List<NhanVienHanhChanh> list;
	private String[] headLine;
	
	public TableModel_NhanVienHanhChanh_RutGon(List<NhanVienHanhChanh> list, String[] headLine) {
		super();
		this.list = list;
	...
	public Class<?> getColumnClass(int columnIndex) {
		if(luongCoBan == columnIndex || ngaySinh == columnIndex || soDienThoai == columnIndex)
